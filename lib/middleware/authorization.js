...
module.exports = function(server, options, validate, immediate) {
  ...
  return function authorization(req, res, next) {
    ...
    server._parse(type, req, function(err, areq) {
      ...
      function validated(err, client, redirectURI, locals) {
        ...
        function immediated(err, allow, info, locals) {
          ...
          if (allow) {
            ...
            req.oauth2.locals = req.oauth2.locals ? utils.merge(req.oauth2.locals, locals) : locals;
            ...
            if (server._txnStore.legacy == true) {
              ...
              server._txnStore.store(req, txn, stored);
            }
          }
        }
