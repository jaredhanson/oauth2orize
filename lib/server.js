...
Server.prototype.responseTypesSupported = function() {
  var arr = []
    , types, type
    , i, len, j, jlen;
  for (i = 0, len = this._resHandlers.length; i < len; ++i) {
    types = this._resHandlers[i].type;
...
Server.prototype.grantTypesSupported = function() {
  return this._exchanges.map(function(ex) { return ex.type; });
}
